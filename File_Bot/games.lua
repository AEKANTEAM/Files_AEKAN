...
❦ ⁞  محيبس ← لعبة المحيبس
❦ ⁞ التخمين ← لعبة البحث
❦ ⁞ الأسرع ← لعبة أسرع شخص
❦ ⁞ سمايلات ← لعبة المطابقه
❦ ⁞ المختلف ← لعبة الذكاء
❦ ⁞ الرياضيات ← لعبة الارقام
❦ ⁞ الانكليزي ← لعبة ترجمه
❦ ⁞ الامثله ← لعبة تصحيح
❦ ⁞ العكس ← لعبة عكس الكلمات
❦ ⁞ الحزوره ←لعبة التفكير
❦ ⁞ المعاني ← اللعبه الشهيره
❦ ⁞ الدول ← لعبة علم الدول
⏦Ⓐ⓷ⓀⓄⓃ ❦ ⓇⓉ⊝ⓎⓉ⏦
لمزيد م̷ـــِْن المعلومات √
راسل مطور البوت °
...
name = string.gsub(name,'اني','مو اني')
...
send(msg.chat_id_, msg.id_,"*❦ ⁞ عذراً لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }*\n")
return false  end 
...
send(msg.chat_id_, msg.id_,'*❦ ⁞ الف مبروك لقد فزت وخمنت الرقم الصحيح*\n*❦ ⁞ تم اضافة { 5 } من النقود*\n')
...
send(msg.chat_id_, msg.id_,'*❦ ⁞ تخمينك غلط* \n*❦ ⁞ ارسل رقم تخمنه مرة اخرى* ')
end
end
end
end
...
send(msg.chat_id_, msg.id_,'\n*❦ ⁞ اهلاً بك عزيزي في لعبة التخمين*\n*ٴ━━━━━━━━━━*\n'..'*❦ ⁞ لديك { 3 } محاولات فقط فكر قبل أرسال تخمينك* \n\n'..'*❦ ⁞ سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد أنك تستطيع الفوز جرب والعب الان ؟* ')
...
send(msg.chat_id_, msg.id_,"*❦ ⁞ عذراً لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مرة اخرى*\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,'*❦ ⁞ الف مبروك لقد فزت وكشفت المحيبس بل ايد رقم* { '..NUM..' }\n*❦ ⁞ لقد حصلت على { 3 } من النقاط يمكنك استبدالهن برسائل* ')
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
AEKAN = {'9','2','60','9','5','4','25','10','17','15','39','5','16',};
name = AEKAN[math.random(#AEKAN)]
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
AEKAN = {'معلومات','قنوات','مجموعات','كتاب','تفاحه','مختلف','سدني','نقود','اعلم','ذئب','تمساح','ذكي',};
name = AEKAN[math.random(#AEKAN)]
...
if text == 'تعطيل الالعاب' and Mod(msg) then   
if database:get(bot_id..'Lock:Games'..msg.chat_id_)  then
