...
ء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
👊|  لعبة البات ← لعبة المحيبس 
🔬| لعبة التخمين ← لعبة البحث
🔍| لعبة الأسرع ← لعبة أسرع شخص
🗳️| لعبة السمايلات ← لعبة المطابقه 
🎭| لعبة المختلف ← لعبة الذكاء
🏧| لعبة الرياضيات ← لعبة الارقام
🗣️| لعبة الانكليزي ← لعبة ترجمه
❇️| لعبة الامثله ← لعبة تصحيح 
📚|لعبة العكس ← لعبة عكس الكلمات
📝| لعبة الحزوره ←لعبة التفكير 
⁉️| لعبة المعاني ← اللعبه الشهيره 
ء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
